...
export function useProductByHandleQuery(baseOptions: Apollo.QueryHookOptions<ProductByHandleQuery, ProductByHandleQueryVariables>) {
        return Apollo.useQuery<ProductByHandleQuery, ProductByHandleQueryVariables>(ProductByHandleDocument, baseOptions);
      }
export function useProductByHandleLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<ProductByHandleQuery, ProductByHandleQueryVariables>) {
          return Apollo.useLazyQuery<ProductByHandleQuery, ProductByHandleQueryVariables>(ProductByHandleDocument, baseOptions);
        }
